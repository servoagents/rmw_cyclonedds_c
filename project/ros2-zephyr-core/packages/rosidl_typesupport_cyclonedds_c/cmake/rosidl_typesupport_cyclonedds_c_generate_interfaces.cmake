...
set(_dds_idl_target
  "${rosidl_generate_interfaces_TARGET}__rosidl_typesupport_cyclonedds_c_dds_idl")
rosidl_generate_dds_interfaces(${_dds_idl_target}
...
set(_output_path
  "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_cyclonedds_c/${PROJECT_NAME}")
foreach(_abs_idl_file ${rosidl_generate_interfaces_ABS_IDL_FILES})
  ...
  list(APPEND _dds_idl_files
    "${_dds_output_base}/${_parent_folder}/${_idl_name}_.idl")
...
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_typesupport_cyclonedds_c_TEMPLATE_DIR}"
...
add_custom_command(
  ...
  ARGS "${rosidl_typesupport_cyclonedds_c_BIN}"
...
target_include_directories(${rosidl_generate_interfaces_TARGET}${_target_suffix} PUBLIC
  "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_cyclonedds_c>"
