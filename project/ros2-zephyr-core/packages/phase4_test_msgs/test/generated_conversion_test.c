...
#include "phase4_test_msgs/msg/detail/nested_fixed__rosidl_typesupport_cyclonedds_c.h"
#include "phase4_test_msgs/msg/detail/nested_fixed__struct.h"
#include "phase4_test_msgs/msg/detail/nested_fixed__type_support.h"
#include "phase4_test_msgs/msg/NestedFixed_.h"
...
int main(void)
{
  ...
  const rosidl_typesupport_cyclonedds_c__message_type_support_callbacks_t * callbacks =
    support->data;
  if (strcmp(callbacks->ros_type_name, "phase4_test_msgs/msg/NestedFixed") != 0 ||
    strcmp(callbacks->dds_type_name,
    "phase4_test_msgs::msg::dds_::NestedFixed_") != 0 ||
    callbacks->descriptor == NULL ||
    callbacks->ros_size != sizeof(phase4_test_msgs__msg__NestedFixed) ||
    callbacks->dds_size != sizeof(phase4_test_msgs_msg_dds__NestedFixed_))
  {
    fprintf(stderr, "generated callback metadata mismatch\n");
    return 2;
  }

  phase4_test_msgs__msg__NestedFixed ros_sample = {0};
  phase4_test_msgs_msg_dds__NestedFixed_ dds_sample = {0};
  phase4_test_msgs__msg__NestedFixed roundtrip = {0};
  ...
  printf(
    "PHASE4_GENERATOR_PASS iterations=%u total_ns=%" PRIu64
    " roundtrip_ns=%" PRIu64 " ros_size=%zu dds_size=%zu value=%" PRIu32 "\n",
    conversion_iterations, total_ns, total_ns / conversion_iterations,
    callbacks->ros_size, callbacks->dds_size, roundtrip.counter.data);
  return 0;
}
